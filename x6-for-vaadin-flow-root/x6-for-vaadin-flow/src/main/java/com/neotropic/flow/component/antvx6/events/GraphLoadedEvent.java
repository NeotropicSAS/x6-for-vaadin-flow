...
/**
* Event fired when a graph is loaded.
* @author Julian David Camacho Erazo {@literal <julian.camacho@kuwaiba.org>}
*/
@DomEvent("graph-loaded")
public class GraphLoadedEvent extends ComponentEvent<AntvX6> {
    private final String status;

    public GraphLoadedEvent(AntvX6 source, boolean fromClient,
